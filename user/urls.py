...
urlpatterns = [
    ...
    path('profile/update-shipping-info', views.update_shipping_info, name='update_shipping_info'),
    path('profile/reviews/<review_id>/delete', views.delete_review, name='delete_review'),
